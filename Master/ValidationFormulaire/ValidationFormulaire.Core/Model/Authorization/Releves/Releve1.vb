...
Public Class Releve1
    ...
    Private Const MAX_MARKER_VALUE As String = "MAX"
    Private Const MIN_MARKER_VALUE As String = "MIN"
    ...
    Public Sub SetReleveMarkers(bar_code_index As Integer) Implements IReleves.SetReleveMarkers
        ...
        If bar_code_index = 0 Then
            ...
            south_marker.Add(MIN_MARKER_VALUE)
            west_marker.Add(MIN_MARKER_VALUE)
            east_marker.Add(MAX_MARKER_VALUE)
            north_occurence_number.Add(2)
        ...
        ElseIf bar_code_index = 3 Then
            ...
            south_marker.AddRange({"- Revenus d'emploi", "A-", "A -"})
            west_marker.Add("Année")
            east_marker.Add("Code du relevé")
            north_occurence_number.Add(1)
            south_occurence_number.AddRange({1, 1, 1})
            west_occurence_number.Add(1)
            east_occurence_number.Add(1)
        ElseIf bar_code_index = 4 Then
            ...
            south_occurence_number.AddRange({1, 1, 1})
            west_occurence_number.Add(1)
            east_occurence_number.AddRange({1, 1, 1})
        ElseIf bar_code_index = 5 Then
            ...
            north_occurence_number.Add(1)
            south_occurence_number.AddRange({1, 1, 1})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.AddRange({1, 1, 1})
        ElseIf bar_code_index = 6 Then
            north_marker.Add(MAX_MARKER_VALUE)
        ...
        ElseIf bar_code_index = 8 Then
            ...
            north_occurence_number.AddRange({1, 1, 1})
            south_occurence_number.AddRange({1, 1, 1})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.AddRange({1, 1, 1})
        ...
        ElseIf bar_code_index = 25 Then
            ...
            east_marker.Add(MAX_MARKER_VALUE)
            north_occurence_number.AddRange({1, 1, 1})
            south_occurence_number.AddRange({1, 1})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.Add(1)
        ...
        ElseIf bar_code_index = 31 Then
            ...
            south_occurence_number.AddRange({1, 1})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.AddRange({1, 1})
        ElseIf bar_code_index = 32 Then
            ...
            east_marker.Add(MAX_MARKER_VALUE)
            north_occurence_number.AddRange({1, 1})
            south_occurence_number.AddRange({1, 1})
            west_occurence_number.AddRange({1, 1})
            east_occurence_number.Add(1)
        ...
        ElseIf bar_code_index = 37 Then
            ...
            north_occurence_number.AddRange({1, 1, 1})
            south_occurence_number.AddRange({2, 2, 2})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.AddRange({2, 2, 2})
        ElseIf bar_code_index = 38 Then
            ...
            west_marker.AddRange({"Numéro, rue,", "appartement,", "case postale"})
            east_marker.AddRange({"Numéro, rue,", "appartement,", "case postale"})
            north_occurence_number.AddRange({2, 2, 2})
            south_occurence_number.AddRange({1, 1})
            west_occurence_number.AddRange({1, 1, 1})
            east_occurence_number.AddRange({2, 2, 2})
        ElseIf bar_code_index = 39 Then
            ...
            south_occurence_number.Add(1)
            west_occurence_number.AddRange({1, 1})
            east_occurence_number.AddRange({2, 2})
        ...
        ElseIf bar_code_index = 44 Then
            ...
            north_occurence_number.AddRange({2, 2, 2})
            south_occurence_number.AddRange({1, 1})
            west_occurence_number.AddRange({2, 2, 2})
            east_occurence_number.Add(1)
        ElseIf bar_code_index = 45 Then
            ...
            east_marker.Add(MAX_MARKER_VALUE)
            north_occurence_number.AddRange({1, 1})
            south_occurence_number.AddRange({2, 2})
            west_occurence_number.AddRange({2, 2, 2})
            east_occurence_number.Add(1)
        ElseIf bar_code_index = 46 Then
            ...
            west_marker.AddRange({"Ville,", "village ou municipalité"})
            east_marker.Add(MAX_MARKER_VALUE)
            north_occurence_number.AddRange({2, 2})
            south_occurence_number.Add(2)
            west_occurence_number.AddRange({2, 2})
            east_occurence_number.Add(1)
