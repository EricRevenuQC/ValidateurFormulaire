Public Class ComparePixelColor
    Public Function DifferentPixelColor(color1a As Integer, color2a As Integer, color1b As Integer, color2b As Integer, color1c As Integer, color2c As Integer, _
